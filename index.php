...
<a target="_blank" class="btn btn-info" href="d.html"><i class="fa fa-qq"></i> 多开模式</a>
         ...
         <tbody>
            <tr class="shuaibi-tip animation-bigEntrance">
                <td class="text-center" style="width: 100px;">
                    <img src="http://q4.qlogo.cn/headimg_dl?dst_uin=25370433&spec=100" alt="avatar" class="img-circle img-thumbnail img-thumbnail-avatar">
                </td>
                <td>
                    <h4><strong>站长</strong></h4>
					<i class="fa fa-fw fa-qq text-primary"></i> 25370433<br><i class="fa fa-fw fa-history text-danger"></i>问题请联系客服
                </td>
...
<table class="table table-borderless table-pricing">
            <tbody>
                ...
                <tr>
                    <td><img src="" width="280" height="380"/></td>
                </tr>
...
<tr><td style="text-align: center;">
				  <a href="" target="_blank" ><span class="STYLE1" style="color: #9f79ee;"><b>【廉价内容无限制的服务器】<br>vps服务器仅供几元一个月</a></b></td><!--2030年11-17日到期-->
